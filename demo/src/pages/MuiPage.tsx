...
import { formComponents, FormWrapper } from '../examples/mui/formComponents'
...
const btnActive = {
  ...btnBase, border: '2px solid #1976d2', background: '#e3f2fd', color: '#1976d2',
}
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
      <nav style={{
        ...
        padding: '0 24px', height: 48, background: '#fff', borderBottom: '1px solid #e5e7eb',
        flexShrink: 0,
      }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button onClick={() => setView('build')}
            style={view === 'build' ? btnActive : btnBase}>Build</button>
          <button onClick={handlePreview}
            style={view === 'preview' ? btnActive : btnBase}>Preview</button>
        </div>
      </nav>
